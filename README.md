...
If you are unfamiliar with python or computers in general I recommend you download the [Win10 64bit Executable](https://github.com/NicholasDawson/ArchiverForGooglePhotos/releases/download/v2.0.1/gparch_cli.v2.0.1.exe.win-amd64.3.9.zip) as it will not require any special installation.
